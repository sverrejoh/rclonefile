  ...
  case 'linux':
    switch (arch) {
      ...
      case 'riscv64':
        if (isMusl()) {
          localFileExisted = existsSync(
            join(__dirname, 'rclonefile.linux-riscv64-musl.node')
          )
          try {
            if (localFileExisted) {
              nativeBinding = require('./rclonefile.linux-riscv64-musl.node')
            } else {
              nativeBinding = require('rclonefile-linux-riscv64-musl')
            }
          } catch (e) {
            loadError = e
          }
          ...
          localFileExisted = existsSync(
            join(__dirname, 'rclonefile.linux-riscv64-gnu.node')
          )
          try {
            if (localFileExisted) {
              nativeBinding = require('./rclonefile.linux-riscv64-gnu.node')
            } else {
              nativeBinding = require('rclonefile-linux-riscv64-gnu')
            }
          } catch (e) {
            loadError = e
          }
      ...
      case 's390x':
        localFileExisted = existsSync(
          join(__dirname, 'rclonefile.linux-s390x-gnu.node')
        )
        try {
          if (localFileExisted) {
            nativeBinding = require('./rclonefile.linux-s390x-gnu.node')
          } else {
            nativeBinding = require('rclonefile-linux-s390x-gnu')
          }
        } catch (e) {
          loadError = e
        }
